/*!
 * jsQR v1.4.0 — https://github.com/cozmo/jsQR  (MIT, © Cosmo Wolfe)
 *
 * VENDORED, NOT LOADED FROM A CDN, and that is the point of it being here.
 * This decodes tickets at a door on venue wifi. A script fetched from a third party
 * at the moment a queue forms is a dependency on the one thing least likely to be
 * working, and the door's whole design is that it keeps admitting people when the
 * line goes down.
 *
 * Loaded lazily — only on a browser with no native BarcodeDetector (every iOS
 * browser, and Firefox), and only when somebody actually presses "Use the camera".
 */
/**

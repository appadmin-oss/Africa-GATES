...
class RegistryController {
    ...
    public function registerSubmit(Request $req,Response $res):Response {
        ...
        foreach(['display_name','email','category','profile_type','country_code'] as $f) if(empty(trim($b[$f]??''))) return $this->view->render($res,'pages/registry/register.twig',['error'=>'Please fill all required fields.','gates_page'=>'register','has_hero'=>false,'current_section'=>'projects','old'=>$b])->withStatus(422);
